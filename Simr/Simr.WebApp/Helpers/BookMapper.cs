...
namespace Simr.WebApp.Helpers
{
    internal static class BookMapper
    {
        ...
        public static Book ToBook(this BookGridModel bookGridModel)
        {
            ...
            {
                AdditionalInfo = bookGridModel.AdditionalInfo,
                Bookshelf = bookGridModel.Bookshelf,
                FlibustaUrl = bookGridModel.FlibustaUrl,
                LibRusEcUrl = bookGridModel.LibRusEcUrl,
                LiveLibUrl = bookGridModel.LiveLibUrl,
                Owner = bookGridModel.Owner,
                Year = bookGridModel.Year,
                ImageUrl = bookGridModel.ImageUrl,
                Id = bookGridModel.Id,
            };
