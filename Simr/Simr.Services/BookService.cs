namespace Simr.Services
{
    ...
    public class BookService : IBookService
    {
                ...
                var book =
                    new
                        Book(
                            ...
                            {
                                AdditionalInfo =
                                    string.Join(" ", BookService.textGenerator.GetWords(100)),
                                ...
                                ImageUrl =
                                    "https://pp.userapi.com/c845417/v845417378/c9115/xmJRnAHnsfo.jpg",
                            };

                BookService.SetAuthors(book, 1, 12);
        ...
        {
            var book =
                new Book("Bible", 1025, BookStatus.Existing)
                    {
                        AdditionalInfo =
                            string.Join(
                                " ",
                                BookService.textGenerator.GetWords(100)),
